...
public interface UserManageMapper {
	...
	public List<Map<String, Object>> selectAllAdministrator(Map<String, Object> map , PageBounds bounds) throws Exception;//查询所有管理员
	...
	public void deleteUserById(Map<String,Object> bean) throws Exception;//删除用户
	public List<Map<String, Object>> selectUserByName(Map<String, Object> map , PageBounds bounds) throws Exception;//按用户名查找职员
