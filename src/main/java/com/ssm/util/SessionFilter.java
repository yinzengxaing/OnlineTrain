...
public class SessionFilter implements Filter {
	...
	private static final String LOGIN_PAGE = "/OnlineTrain/html/user/login.html";//前台登录界面
	
	private static final String WECHAT_POST = "/OnlineTrain/server/WechatPost";//微信请求--直接通过请求
